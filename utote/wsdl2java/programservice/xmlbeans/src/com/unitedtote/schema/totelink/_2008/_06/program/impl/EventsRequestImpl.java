 ...
 */
public class EventsRequestImpl extends com.unitedtote.schema.totelink._2008._06.common.impl.ToteLinkRequestImpl implements com.unitedtote.schema.totelink._2008._06.program.EventsRequest
{
    
    public EventsRequestImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName RACES$4 = 
    ...
    public boolean getRaces()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(RACES$4, 0);
            if (target == null)
            {
                return false;
            }
    ...
    public org.apache.xmlbeans.XmlBoolean xgetRaces()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlBoolean)get_store().find_element_user(RACES$4, 0);
            return target;
        }
    }
    ...
    public boolean isSetRaces()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(RACES$4) != 0;
        }
    }
    ...
    public void setRaces(boolean races)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(RACES$4);
            }
    ...
    public void xsetRaces(org.apache.xmlbeans.XmlBoolean races)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_store().add_element_user(RACES$4);
            }
            target.set(races);
        }
    }
    ...
    public void unsetRaces()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(RACES$4, 0);
        }
    }
}
