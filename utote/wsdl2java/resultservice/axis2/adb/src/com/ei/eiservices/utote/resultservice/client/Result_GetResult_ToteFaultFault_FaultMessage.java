...
public class Result_GetResult_ToteFaultFault_FaultMessage extends java.lang.Exception {
    ...
    private com.ei.eiservices.utote.resultservice.client.ResultServiceStub.ToteLinkFaultE faultMessage;
    ...
    public void setFaultMessage(
        com.ei.eiservices.utote.resultservice.client.ResultServiceStub.ToteLinkFaultE msg) {
        faultMessage = msg;
    }

    public com.ei.eiservices.utote.resultservice.client.ResultServiceStub.ToteLinkFaultE getFaultMessage() {
        return faultMessage;
    }
}
