    ...
    public static class Factory {
        ...
        public static Updates parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                log4j.trace("Updates - Looking for Element = {}, found = {}", "Updates", reader.getName());

                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    java.lang.String fullTypeName = reader
                            .getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type");
                    if (fullTypeName != null) {
                        log4j.trace("Updates - fullTypeName = {}", fullTypeName);
                ...
                while (!done) {
                    ...
                    if (reader.isEndElement()) {
                        // We are done!
                        log4j.trace("Updates - Found End element, exiting while loop");
                        done = true;
                        break;
                    }
