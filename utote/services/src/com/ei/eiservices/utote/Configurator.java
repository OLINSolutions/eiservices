...
public class Configurator {
	...
	public static void init(){
		...
		try {
			...
			assert (null != tempstr) : "Property, " + UTOTE_PASSWORD + ", returned a null value";
			_properties.put(UTOTE_EVENT_TRACK_TYPES, (List<String>)Arrays.asList(tempstr.split("\\s*,\\s*")));
	...
	public static EntityManagerFactory getRWEMF() {
		// if factory is missing, create it
		EntityManagerFactory emFactory = Persistence.createEntityManagerFactory(PERSISTENCE_UNIT_NAME, getDbRWProps());
