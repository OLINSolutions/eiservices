...
public class Result_GetResult_ValidationFaultFault_FaultMessage extends java.lang.Exception {
    ...
    private com.ei.eiservices.utote.client.resultservice.ResultServiceStub.ValidationFaultE faultMessage;
    ...
    public void setFaultMessage(
        com.ei.eiservices.utote.client.resultservice.ResultServiceStub.ValidationFaultE msg) {
        faultMessage = msg;
    }

    public com.ei.eiservices.utote.client.resultservice.ResultServiceStub.ValidationFaultE getFaultMessage() {
        return faultMessage;
    }
}
