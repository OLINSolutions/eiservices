...
-- Migrated Schemata: rtwbeta
-- Source Schemata: rtwbeta
-- Created: Fri Jul 31 18:28:00 2015
...
-- Schema rtwbeta
-- ----------------------------------------------------------------------------
DROP SCHEMA IF EXISTS `rtwbeta` ;
CREATE SCHEMA IF NOT EXISTS `rtwbeta` ;

-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteAccountContests
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteAccountContests` (
  ...
  CONSTRAINT `fk_utoteAccountContests_utoteRequired1`
    ...
    REFERENCES `rtwbeta`.`utoteRequired` (`idUtoteRequired`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteRequired
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteRequired` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteAdvertisements
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteAdvertisements` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteChannels
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteChannels` (
  ...
  CONSTRAINT `fk_utoteChannels_utoteConfigurations`
    ...
    REFERENCES `rtwbeta`.`utoteConfigurations` (`idUtoteConfiguration`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteConfigurations
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteConfigurations` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteCurrencies
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteCurrencies` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteDemands
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteDemands` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteEntries
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteEntries` (
  ...
  CONSTRAINT `fk_utoteEntries_utoteRunners`
    ...
    REFERENCES `rtwbeta`.`utoteRunners` (`idUtoteRunner`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 7762
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteRunners
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteRunners` (
  ...
  CONSTRAINT `fk_utoteRunners_utoteRaces1`
    FOREIGN KEY (`idParent`)
    REFERENCES `rtwbeta`.`utoteRaces` (`idUtoteRace`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteEntriesHistory
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteEntriesHistory` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteErrors
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteErrors` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteEvents
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteEvents` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteEventsHistory
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteEventsHistory` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteFinishers
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteFinishers` (
  ...
  CONSTRAINT `fk_utoteFinishers_utotePositions1`
    ...
    REFERENCES `rtwbeta`.`utotePositions` (`idUtotePosition`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utotePositions
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utotePositions` (
  `idUtotePosition` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_utotePositions_utoteRaceResults1`
    ...
    REFERENCES `rtwbeta`.`utoteRaceResults` (`idUtoteRaceResult`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteLanguages
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteLanguages` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteLimits
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteLimits` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utotePoolPrices
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utotePoolPrices` (
  ...
  CONSTRAINT `fk_utotePoolPrices_utoteResultResponses1`
    ...
    REFERENCES `rtwbeta`.`utoteResultResponses` (`idUtoteResultResponse`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteResultResponses
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteResultResponses` (
  `idUtoteResultResponse` INT(11) NOT NULL,
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utotePools
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utotePools` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteRaces
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteRaces` (
  ...
  CONSTRAINT `fk_utoteRaces_utoteEvents`
    FOREIGN KEY (`idParent`)
    REFERENCES `rtwbeta`.`utoteEvents` (`idUtoteEvent`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
AUTO_INCREMENT = 1950
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utotePoolsHistory
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utotePoolsHistory` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteRaceResults
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteRaceResults` (
  `idUtoteRaceResult` INT(11) NOT NULL,
  `idUtoteResultResponse` INT(11) NOT NULL,
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utotePrices
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utotePrices` (
  ...
  CONSTRAINT `fk_utotePrices_utotePoolPrices1`
    ...
    REFERENCES `rtwbeta`.`utotePoolPrices` (`idUtotePoolPrice`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteRacesHistory
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteRacesHistory` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteRequestLog
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteRequestLog` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteRequestLogHistory
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteRequestLogHistory` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteResponseLog
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteResponseLog` (
  ...
  CONSTRAINT `fk_utoteResponseLog_utoteErrors1`
    ...
    REFERENCES `rtwbeta`.`utoteErrors` (`ErrorNumber`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_utoteResponseLog_utoteRequestLog`
    FOREIGN KEY (`idUtoteRequestLog`)
    REFERENCES `rtwbeta`.`utoteRequestLog` (`idUtoteRequestLog`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 438
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteResponseLogHistory
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteResponseLogHistory` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteRunnersHistory
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteRunnersHistory` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteStatusChanges
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteStatusChanges` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteStatusChangesHistory
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteStatusChangesHistory` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteUpdates
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteUpdates` (
...
-- ----------------------------------------------------------------------------
-- Table rtwbeta.utoteUpdatesHistory
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `rtwbeta`.`utoteUpdatesHistory` (
...
-- ----------------------------------------------------------------------------
-- Routine rtwbeta.PrepareUtoteForNewDay
-- ----------------------------------------------------------------------------
DELIMITER $$
